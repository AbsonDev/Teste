    ...
    <div className="flex flex-col h-full bg-white dark:bg-gray-800 relative transition-colors">
      <div className="p-6 pb-0 bg-brand-50 dark:bg-gray-900/50 border-b border-brand-100 dark:border-gray-700 flex-shrink-0 relative">
        ...
        <div className="mb-6">
          <button
            ...
            className={`w-full flex items-center gap-3 p-3 rounded-xl border transition-all shadow-sm group relative overflow-hidden ${
              isPantryActive 
                ...
                : 'bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700 text-gray-700 dark:text-gray-200 hover:bg-orange-50 dark:hover:bg-gray-700/50 hover:border-orange-200 hover:-translate-y-0.5'
            }`}
          >
            <div className={`p-2 rounded-lg transition-colors ${isPantryActive ? 'bg-orange-100 dark:bg-orange-900/50 text-orange-600 dark:text-orange-300' : 'bg-gray-100 dark:bg-gray-700 text-gray-500 dark:text-gray-400 group-hover:bg-orange-100 group-hover:text-orange-600'}`}>
            ...
            {isPantryActive && (
                <div 
                    ...
                    className="absolute right-2 top-1/2 -translate-y-1/2 p-2 text-orange-400 hover:text-orange-600 hover:bg-orange-100 dark:hover:bg-orange-900/30 rounded-lg cursor-pointer"
                    title={t('share')}
                    aria-label={t('share')}
                >
      ...
      <div className="p-4 space-y-3 bg-gray-50 dark:bg-gray-900/50 border-t border-gray-100 dark:border-gray-700 flex-shrink-0">
        ...
        <div className="flex justify-center gap-4 py-1">
            <button onClick={() => changeLanguage('pt')} className={`text-xl hover:scale-110 transition-transform ${currentLang.startsWith('pt') ? 'opacity-100' : 'opacity-50'}`} title="Português">🇧🇷</button>
            <button onClick={() => changeLanguage('en')} className={`text-xl hover:scale-110 transition-transform ${currentLang.startsWith('en') ? 'opacity-100' : 'opacity-50'}`} title="English">🇺🇸</button>
            <button onClick={() => changeLanguage('es')} className={`text-xl hover:scale-110 transition-transform ${currentLang.startsWith('es') ? 'opacity-100' : 'opacity-50'}`} title="Español">🇪🇸</button>
        </div>
